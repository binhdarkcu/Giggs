	...
	<?php
		function display_custom_comments($comment, $args, $depth) {
		   ...
		   <li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
		     <div id="comment-<?php comment_ID(); ?>" <?php if($isByAuthor){ echo 'class="author the-comment clearfix"';}?>>
		      ...
		      <div class="comment-core">
		      	<div class="comment-author">
					<strong><?php printf(__('%s'), get_comment_author()) ?></strong> said on June 9, 2014 at 5:06 pm: 
					<?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?>				
				</div><!-- end .comment-author .meta -->
