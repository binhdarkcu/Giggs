...
/*music*/
add_action( 'init', 'register_custom_post_about_lightbox' );
function register_custom_post_about_lightbox() {	
	$news_label = array(
    'name' => _x('About Lightbox', 'About Lightbox'),
    'singular_name' => _x('about-lightbox', 'about-lightbox'),
    'add_new' => _x('Add New', 'About Lightbox'),
    'add_new_item' => __('Add New'),
    'edit_item' => __('Edit '),
    'new_item' => __('Add New'),
    'all_items' => __('View All'),
  ...
  $news= array(
   ...
   'show_in_nav_menus'=>true,
    'query_var' => true,
    'rewrite' =>  array('slug'=>'about-lightbox'),
    'capability_type' => 'post',
    'has_archive' => true, 
    'hierarchical' => false,
    'menu_position' => 5,  
